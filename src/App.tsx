      ...
      <SidebarInset>
        ...
        <div className="flex flex-1 flex-col gap-4 p-4 pt-0 bg-background">
          <div className="grid auto-rows-min gap-4 md:grid-cols-3 mt-4">
            <div className="bg-card border border-border aspect-video rounded-xl shadow-sm" />
            <div className="bg-card border border-border aspect-video rounded-xl shadow-sm" />
            <div className="bg-card border border-border aspect-video rounded-xl shadow-sm" />
          </div>
          <div className="bg-card border border-border min-h-[100vh] flex-1 rounded-xl shadow-sm md:min-h-min" />
        </div>
      </SidebarInset>
    </SidebarProvider>
  )
