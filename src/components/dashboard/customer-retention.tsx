      ...
      <div className="space-y-4 md:space-y-6">
        ...
        <div>
          ...
          <div className="relative h-2 md:h-2.5 bg-muted rounded-full overflow-hidden">
            <div 
              className="absolute inset-y-0 left-0 w-[25%] bg-linear-to-r from-[#FFD550] to-[#f7d34a] rounded-full transition-all duration-500"
        ...
        <div>
          ...
          <div className="relative h-2 md:h-2.5 bg-muted rounded-full overflow-hidden">
            <div 
              className="absolute inset-y-0 left-0 w-[31%] bg-linear-to-r from-[#FFD550] to-[#f7d34a] rounded-full transition-all duration-500"
              style={{ boxShadow: '0 0 8px rgba(247, 211, 74, 0.5)' }}
            ></div>
          </div>
          <p className="text-xs text-muted-foreground mt-1.5">
        ...
        <div>
          ...
          <div className="relative h-2 md:h-2.5 bg-muted rounded-full overflow-hidden">
            <div 
              className="absolute inset-y-0 left-0 w-[69%] bg-linear-to-r from-[#FFD550] to-[#f7d34a] rounded-full transition-all duration-500"
              style={{ boxShadow: '0 0 8px rgba(247, 211, 74, 0.5)' }}
            ></div>
          </div>
          <p className="text-xs text-muted-foreground mt-1.5">
